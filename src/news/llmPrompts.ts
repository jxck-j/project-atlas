...
domesticNoStateResponse is true for a domestic incident (crime, shooting, disaster) with no state security or diplomatic response and no international dimension; such items are capped at significant.
