...
4. **Legal follow-ups are not a new casualty.** A verdict against an ex-head-of-state or ex-leader (a war-crimes sentence) is **Major**; arrests, extraditions and trials over a *past* head-of-state killing are **Significant**. The Critical "head-of-state casualty" trigger is for a new event only.
...
** Formally severing relations is **Major**. Expelling or recalling an ambassador (without severing relations) is **Significant**.** A verdict against an ex-head-of-state or ex-leader (a war-crimes sentence) is **Major**; arrests, extraditions and trials over a *past* head-of-state killing are **Significant**. The Critical "head-of-state casualty" trigger is for a new event only.
