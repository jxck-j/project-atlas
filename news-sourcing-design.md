...
|-----------------|------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Critical**    | Wire-confirmed **only**                        | Auto-publishes once wire-confirmed — no manual gate — **except** head-of-state/government death claims specifically, which require manual confirmation even after wire confirmation. No exceptions on the wire-only corroboration floor itself, even with 2+ independent OSINT corroborations or specialist-verified status. |
